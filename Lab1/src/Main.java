...
public class Main {
    ...
    public static void compute(WorkingSet workingSet) throws InterruptedException {
        //Створення об'єктів в яких будуть зберегатися результати обчислення потоків
        ...
        bPlusCMaxThread.join();
        cMultMtMultAThread.join();
        ...
        MaxMultMdMultMtPlusMzMultMbThread.join();
        bMultMdPlusCMultMtMultAThread.join();
